...
form-cross-view 是一个跨视图表单生成框架，它是基于并扩展了 [async-validator](https://github.com/yiminghe/async-validator) 数据描述规范， 分离了表单逻辑与视图，支持自定义基于不同业务框架、UI 组件库的视图。
...
<a href="https://github.com/IDonotK/form-cross-view" target="_blank">点击打开详细说明</a>
